...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #导入机器学习模型
        self.clf = joblib.load('model/clf.model')
            ...
            if pkt_udp.dst_port==53 or pkt_udp.src_port == 53:
                ...
                if db.iswhite_list(queriy_name) == 0:
                    ...
                    if db.isblack_list(queriy_name):
                        ...
                        featureVec = getFeatureVector(queriy_name)
                        if clf.predict(featureVec) == 1:
                            print '恶意网站：' + queriy_name
                            return
